...
- Protected dashboard content stays mounted during the client-side verification pass, and the last database-verified role is cached only to keep navigation visually stable.
