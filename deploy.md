...
6. Dashboard content remains mounted during the client verification pass, while the navigation may use the last database-verified role as a display-only cache. Proxy checks and RLS remain authoritative.
